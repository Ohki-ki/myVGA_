...
xst -ifn xst.scr
move myClockManager_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\myClockManager_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc myClockManager_exdes.ucf myClockManager_exdes

echo 'Running map'
map -timing -pr b myClockManager_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm myClockManager_exdes -w routed.ncd routed.vhd
cd ..
