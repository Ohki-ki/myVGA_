...
xst -ifn xst.scr
move myClockerManager_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\myClockerManager_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc myClockerManager_exdes.ucf myClockerManager_exdes

echo 'Running map'
map -timing -pr b myClockerManager_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm myClockerManager_exdes -w routed.ncd routed.vhd
cd ..
